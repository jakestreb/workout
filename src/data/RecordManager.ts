...
export class RecordManager {
  ...
  public async init(): Promise<void> {
    ...
    await this._run(`CREATE INDEX idx_records_user_id ON records(user_id)`);
    await this._run(`CREATE INDEX idx_records_user_id_exercise ON records(user_id, exercise)`);
  }
